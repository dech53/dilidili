...
import 'package:dilidili/common/widgets/loading_widget/morphs.dart';
...
class _M3ELoadingIndicatorState extends State<M3ELoadingIndicator>
  ...
  double _calcAngle(double progress) {
    final elapsedInMs = _morphIntervalMs * (_morphIndex - 1) +
        (_controller.lastElapsedDuration?.inMilliseconds ?? 0);
    final globalRotation = (elapsedInMs % _globalRotationDurationMs) /
