import 'package:dilidili/pages/login/controller.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _showQrLoginDialog() {
    Future? qrCodeFuture = _loginPageCtr.getWebQrcode();
    showDialog(
      context: context,
      builder: (context) {
          ...
          builder: (context, StateSetter setState) {
            return AlertDialog(
              title: Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      setState(() {
                        qrCodeFuture = _loginPageCtr.getWebQrcode();
                      });
                    },
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () => _loginPageCtr.queryWebQrcodeStatus(),
                  child: Text(
                    '检查登录状态',
                    style: TextStyle(
                      fontSize:
    ...
    ).whenComplete(_loginPageCtr.stopWebQrcodePolling);
  }
