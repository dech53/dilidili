import 'package:dilidili/common/business_type.dart';
...
class HistoryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String heroTag = StringUtils.makeHeroTag(aid);
    return InkWell(
      onTap: () async {
        ...
        if (videoItem.history.business.contains('article')) {
          ...
          if (bvid != null && bvid != '') {
            ...
            if (result['status']) {
              ...
              String heroTag = StringUtils.makeHeroTag(cid);
                                    ...
                                    if (!BusinessType
                                      ...
                                      PBadge(
                                        text: videoItem.progress == -1
                                            ? '已看完'
                                            : '${NumUtils.int2time(videoItem.progress!)}/${NumUtils.int2time(videoItem.duration!)}',
                                        right: 6.0,
                                        bottom: 8.0,
                                        type: 'gray',
                                      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  NumUtils.dateFormat(videoItem.viewAt!),
                  style: TextStyle(
                      fontSize:
                          Theme.of(context).textTheme.labelMedium!.fontSize,
                      color: Theme.of(context).colorScheme.outline),
