...
import 'package:dilidili/utils/drawer.dart';
...
class BangumiIntroController extends GetxController {
  ...
  var seasonId = Get.arguments['seasonId'] != null
      ? int.parse(Get.arguments['seasonId']!)
      : null;
  var epId = Get.arguments['epId'] != null
      ? int.tryParse(Get.arguments['epId']!)
      : null;
  ...
  Future actionShareVideo() async {
    var result = await Share.share('${ApiString.baseUrl}/video/$bvid')
        .whenComplete(() {});
    return result;
  }
